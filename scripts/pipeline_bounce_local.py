...
def ledger_view(path, owner_repo, pr_number):
    """{'prior', 'last_spent', 'exhausted', 'concluded', 'notices'} for one PR. Only
    ...
    prior, last_spent, exhausted, concluded, notices = 0, None, None, None, []
    ...
    return {"prior": prior, "last_spent": last_spent, "exhausted": exhausted,
            "concluded": concluded, "notices": notices}
...
def selftest():
    ...
    # 5c. AFTER a conclusion. A conclusion is a HAND-OFF: the coding ticket is in the
    ...
    # 5d. The notice body: what changed, where the ticket is, and no marker anything trusts.
    ...
    print("ok — pipeline_bounce_local: N-1/N/N+1 ⇒ bounce/bounce/exhaust, a raised budget "
          ...
          "budgets.maxBounces still buys a round; C1: one config file serves both components "
