...
| [Todoclaw-parity hook hardening](2026-08-23-todoclaw-parity-hook-hardening.md) | 2026-08-23 | stderr block reasons; path-target secret guard (+id_rsa/credentials); egress guard; anchored rm flags; settings.local.json + widened mutation net self-protected; fail-closed dispatch; session root from hook-process cwd (subagent worktree fix) |
