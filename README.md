...
| `docs/STAGE-E-OPERATOR.md` | **Pipeline only**: operator steps for Stage E (automated review + bounded fix re-prompt of dispatcher-opened PRs) — the Reviews team, the dispatcher's review entry, the owner-account poller, dry run, live tests |
